...
def is_locked():
    is_locked = subprocess.check_output(
        "qdbus org.kde.screensaver /ScreenSaver org.freedesktop.ScreenSaver.GetActive", shell=True, universal_newlines=True).strip()
    if is_locked == "true":
        is_locked = True
    else:
        is_locked = False
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--file', '-f', help='Wallpaper file name', default=None)
    parser.add_argument(
